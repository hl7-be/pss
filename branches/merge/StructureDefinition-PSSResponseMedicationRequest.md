# PSS Response Medication Request - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSResponseMedicationRequest | *Version*:1.1.0 |
| Active as of 2026-03-05 | *Computable Name*:PSSResponseMedicationRequest |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-03-05T12:38:02+00:00",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSPatient"]
      }]
    }]
  }
}
