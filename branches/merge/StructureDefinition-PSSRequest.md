# PSS Request - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSRequest | *Version*:1.1.0 |
| Active as of 2026-03-05 | *Computable Name*:PSSRequest |
| *Other Identifiers:*OID:2.16.840.1.113883.2.51.22.2.42.8 | |

 
Request for PSS (Prescriber Support System) results. 
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "path" : "PSSRequest",
      "short" : "PSS Request",
      "definition" : "Request for PSS (Prescriber Support System) results."
    },
    {
