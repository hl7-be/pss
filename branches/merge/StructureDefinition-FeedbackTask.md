# PSS Feedback Task - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/FeedbackTask | *Version*:1.1.0 |
| Active as of 2026-03-05 | *Computable Name*:FeedbackTask |
...
* Examples for this Profile: [Task/task-accepted-green-a](Task-task-accepted-green-a.md), [Task/task-accepted-green-r](Task-task-accepted-green-r.md), [Task/task-accepted-green](Task-task-accepted-green.md), [Task/task-accepted-orange-a](Task-task-accepted-orange-a.md)... Show 2 more, [Task/task-accepted-orange-r](Task-task-accepted-orange-r.md) and [Task/task-accepted-other-r](Task-task-accepted-other-r.md)
