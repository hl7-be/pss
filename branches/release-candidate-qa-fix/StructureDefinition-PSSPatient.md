# PSS anonymised Patient - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSPatient | *Version*:1.1.0 |
| Active as of 2026-02-27 | *Computable Name*:PSSPatient |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSRelevantAge"]
      }]
    },
    {
