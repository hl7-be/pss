# PSS Data Acquisition Form - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSDataAcquisitionForm | *Version*:1.1.0 |
| Active as of 2026-02-27 | *Computable Name*:PSSDataAcquisitionForm |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/CodeValueSet"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/AnswerOptionAdditionalCode"]
      }]
    }]
  }
}
