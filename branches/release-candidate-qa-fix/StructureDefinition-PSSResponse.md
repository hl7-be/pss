# PSS Response - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSResponse | *Version*:1.1.0 |
| Active as of 2026-02-27 | *Computable Name*:PSSResponse |
| *Other Identifiers:*OID:2.16.840.1.113883.2.51.22.2.42.10 | |

 
Response containing the results from the PSS. 
...
```json
{
  ...
  "differential" : {
    "element" : [{
      ...
      "path" : "PSSResponse",
      "short" : "PSS Response",
      "definition" : "Response containing the results from the PSS."
    },
    {
