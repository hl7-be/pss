# PSS Consent - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSConsentModel | *Version*:1.1.0 |
| Active as of 2026-02-27 | *Computable Name*:PSSConsentModel |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "PSSConsentModel.hcpID",
      "path" : "PSSConsentModel.hcpID",
