# Antimicrobiology - S3 Get Recommendations - Response - 1. Bundle - Prescription Search Support v1.1.0
...
```json
{
  ...
  "entry" : [{
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSResponseRequestGroup"]
      },
      "text" : {
        "status" : "extensions",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSResponseCommunicationRequest"]
      },
      "text" : {
        "status" : "extensions",
