# Artifacts Summary - Prescription Search Support v1.1.0
...
| [PSS Request](StructureDefinition-PSSRequest.md) | Request for PSS (Prescriber Support System) results. |
| [PSS Response](StructureDefinition-PSSResponse.md) | Response containing the results from the PSS. |
...
| | |
| :--- | :--- |
| [Antimicrobial - Another option that is not in the recommendations](MedicationRequest-alternative-request.md) | The alternative treatment that is not in the PSS recommendations |
...
| [Antimicrobial - Select orange recommendation](Task-task-accepted-orange-a.md) | Prescriber selects an orange antimicrobial recommendation with a reason |
| [Antimicrobial - Use another option that is not in the recommendations](Task-alternative-request-task.md) | task indicating the use of another treatment that is not in the PSS recommendations |
...
| [Antimicrobial feedback - red recommendation](Parameters-antimicrobial-feedback-orange.md) | Prescriber selects an red antimicrobial recommendation with a reason |
...
| [PSS Feedback Bundle](StructureDefinition-PSSFeedbackBundle.md) | The PSS Response Bundle is used to return data from the PSS system. |
...
| [Feedback - alternative](Bundle-alternative-request-bundle.md) | Example of feedback - alternative option. |
...
| [Radiology feedback](Parameters-radiology-feedback.md) | Feedback Parameters example - Radiology |
...
| | |
| :--- | :--- |
| [Example of consent/statistics preference](QuestionnaireResponse-qr-consent-example.md) | Example of how to provide consent and statistics preference in PSS. |
| [Feedback: accepted green recommendation](Parameters-feedback-accepted-green.md) | Example feedback parameters - accepted recommendation for a green task. |
| [task-accepted-green](Task-task-accepted-green.md) | Example feedback task - accepted recommendation for a green task. |
