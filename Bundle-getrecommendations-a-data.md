# Antimicrobiology - S3 Get Recommendations - Request- 1. Bundle - Prescription Search Support v1.1.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSRequestBundle"]
  },
  "type" : "collection",
  "entry" : [{
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSPatient"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSMedicationRequest"]
      },
      "text" : {
        "status" : "generated",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-questionnaireresponse"]
      },
      "text" : {
        "status" : "generated",
