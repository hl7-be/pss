...
InstanceOf: Task
Usage: #example
* insert proposeDiagnosisTask(Radiology - S3 - Get Diagnoses,X,stroke,Stroke,3074220)
...
Usage: #example
* insert proposeDiagnosisCondition(Radiology - S3 - Get Diagnoses,X,stroke,Stroke,3074220)
...
InstanceOf: Task
Usage: #example
* insert proposeDiagnosisTask(Radiology - S3 - Get Diagnoses,X,infection,Infection,3074221)
...
InstanceOf: Condition
Usage: #example
* insert proposeDiagnosisCondition(Radiology - S3 - Get Diagnoses,X,infection,Infection,3074221)
...
InstanceOf: Task
Usage: #example
* insert proposeDiagnosisTask(Radiology - S3 - Get Diagnoses,X,head-trauma,Head trauma,5000246)
...
InstanceOf: Condition
Usage: #example
* insert proposeDiagnosisCondition(Radiology - S3 - Get Diagnoses,X,head-trauma,Head trauma,5000246)
...
InstanceOf: Task
Usage: #example
* insert proposeDiagnosisTask(Radiology - S1 - Get Diagnoses,X,slow-progression-ataxia,Chronic or slow progression-ataxia,3074219)
...
InstanceOf: Condition
Usage: #example
* insert proposeDiagnosisCondition(Radiology - S1 - Get Diagnoses,X,slow-progression-ataxia,Chronic or slow progression-ataxia,3074219)
...
InstanceOf: Task
Usage: #example
* insert proposeDiagnosisTask(Radiology - S1 - Get Diagnoses,X,post-trauma-ataxia,Post-trauma ataxia,3074222)
...
InstanceOf: Condition
Usage: #example
* insert proposeDiagnosisCondition(Radiology - S1 - Get Diagnoses,X,post-trauma-ataxia,Post-trauma ataxia,3074222)
