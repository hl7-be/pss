...
* item.item[=].initial.valueCoding = $sct#921000172108
* item.item[+].extension.url = "http://hl7.org/fhir/StructureDefinition/questionnaire-hidden"
* item.item[=].extension.valueBoolean = true
* item.item[=].linkId = "inention"
* item.item[=].text = "Intention"
* item.item[=].type = #choice
* item.item[=].required = true
* item.item[=].initial.valueCoding = $atc#J01CA04 "Amoxicillin"
* item.item[+].linkId = "sp_alertSignals_ast"
...
* item.item[=].item[=].item.item[=].answerOption[=].valueCoding = $sct#277785006
* item.item[=].item[=].item.item[=].answerOption[+].valueCoding.version = "http://snomed.info/sct/11000172109"
