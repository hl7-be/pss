...
* item.item[=].initial.valueCoding = $sct#422588002
* item.item[+].linkId = "sp_penicillinAllergyGroup"
* item.item[=].type = #group
* item.item[=].item[0].linkId = "sp_penicillinAllergy"
...
* item.item[=].item[=].item[0].linkId = "pv_amoxicilline_proposals"
* item.item[=].item[=].item[=].type = #group
* item.item[=].item[=].item[=].item[0].linkId = "pv_amoxicilline"
...
* item.item[=].item[=].type = #group
* item.item[=].item[=].repeats = true
* item.item[=].item[=].item[0].linkId = "pv_ageOver65_proposals"
* item.item[=].item[=].item[=].type = #group
* item.item[=].item[=].item[=].item[0].linkId = "pv_ageOver65"
