...
* item[=].answerOption[=].valueCoding.display = "Ik geef toestemming om gegevens over mijn gebruik van deze app anoniem te verzamelen op het niveau van mijn onderwijsinstelling (cluster) voor statistische doeleinden."
  * valueCoding.display.extension[http://hl7.org/fhir/StructureDefinition/translation].extension[lang].valueCode = #fr-BE
  * valueCoding.display.extension[http://hl7.org/fhir/StructureDefinition/translation].extension[content].valueString = "Je donne mon consentement pour que les données concernant mon utilisation de cette application soient collectées anonymement au niveau de mon établissement d'enseignement (cluster) à des fins statistiques."
...
* item[=].answerOption[=].valueCoding.display = "Ik geef de voorkeur aan volledige anonimiteit wanneer voor statistische doeleinden gegevens worden verzameld over mijn gebruik van deze app."
  * valueCoding.display.extension[http://hl7.org/fhir/StructureDefinition/translation].extension[lang].valueCode = #fr-BE
  * valueCoding.display.extension[http://hl7.org/fhir/StructureDefinition/translation].extension[content].valueString = "Je préfère une anonymité totale lors de la collecte de données sur mon utilisation de cette application à des fins statistiques."
