# Antimicrobiology - S2 Get data to collect - Response - 1. Bundle - Prescription Search Support v1.1.0
...
```json
{
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://www.ehealth.fgov.be/standards/fhir/pss/StructureDefinition/PSSDataAcquisitionForm"]
      },
      "language" : "nl-BE",
      "text" : {
        "status" : "generated",
