# Home - Prescription Search Support v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/pss/ImplementationGuide/hl7.fhir.be.pss | *Version*:1.1.0 |
| Active as of 2026-02-27 | *Computable Name*:PrescriptionSearchSupport |
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "MedicationRequest/alternative-request"
      },
      "name" : "Antimicrobial - Another option that is not in the recommendations",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Task/task-accepted-orange-a"
      },
      "name" : "Antimicrobial - Select orange recommendation",
    ...
    },
    {
      ...
      "name" : "Antimicrobial - Use another option that is not in the recommendations",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Parameters/antimicrobial-feedback-orange"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "QuestionnaireResponse/qr-consent-example"
      },
      "name" : "Example of consent/statistics preference",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Parameters/feedback-accepted-green"
      },
      "name" : "Feedback: accepted green recommendation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Task/task-accepted-green"
      },
      "name" : "task-accepted-green",
